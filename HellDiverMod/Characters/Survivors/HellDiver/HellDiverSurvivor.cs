...
{               new CustomRendererInfo
        ...
        private void AddPrimarySkills()
        {
            ...
            ReloadSkillDef revovlerSkillDef = Skills.CreateReloadSkillDef(new ReloadSkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(DiverFireRevolver)),
                activationStateMachineName = "Weapon",
            ...
            ReloadSkillDef shotgunSkillDef = Skills.CreateReloadSkillDef(new ReloadSkillDefInfo
            {
                skillName = "HellDiverShotgun",
                skillNameToken = HELLDIVER_PREFIX + "PRIMARY_SHOTGUN_NAME",
                skillDescriptionToken = HELLDIVER_PREFIX + "PRIMARY_SHOTGUN_DESCRIPTION",
                keywordTokens = new string[] { },
                skillIcon = assetBundle.LoadAsset<Sprite>("texSecondaryIcon"),

                activationState = new EntityStates.SerializableEntityStateType(typeof(DiverFireShotgun)),
                activationStateMachineName = "Weapon",
                interruptPriority = EntityStates.InterruptPriority.Skill,
            ...
            Skills.AddPrimarySkills(bodyPrefab, pistolDef, arSkillDef, shotgunSkillDef, revovlerSkillDef);
        }
